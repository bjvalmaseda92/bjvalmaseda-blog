<div class="min-h-full">
    <nav class="bg-gray-800" x-data='{mobileOpen: false}'>
            ...
            <div class="flex items-center justify-between h-16">
                <div class="flex items-center">
                    ...
                    <div class="hidden md:block">
                        <div class="ml-10 flex items-baseline space-x-4">
                            ...
                            <x-nav-link href="{{route('home')}}" :active="request()->routeIs('home')">Inicio
                            </x-nav-link>
                        ...
                        <div class="ml-3 relative" x-data='{open: false}'>
                            <div>
                                <button type="button"
                                    ...
                                    <img class="h-8 w-8 rounded-full" src="" alt="Text">
                                </button>
                            </div>
                ...
                <div class="-mr-2 flex md:hidden">
                    ...
                    <button type="button"
                        ...
                        aria-controls="mobile-menu" aria-expanded="false" @click="mobileOpen =!mobileOpen">
        ...
        <div class="md:hidden" id="mobile-menu" :class="{'block': mobileOpen, 'hidden': ! mobileOpen}">
            <div class="px-2 pt-2 pb-3 space-y-1 sm:px-3">
                <x-nav-link-mobile :active="request()->routeIs('home')">Inicio</x-nav-link-mobile>
            </div>
            @auth
